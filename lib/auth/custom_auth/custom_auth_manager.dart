...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    hhmsAuthUserSubject.add(
      HhmsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HhmsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HhmsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HhmsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    hhmsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
